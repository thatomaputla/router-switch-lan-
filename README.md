...
Devices used:	1 Router (central interconnection point)
...
Logical design: Each department is connected to its own switch. The switches are connected to the router, which routes traffic between the two subnets.
LAN 1 (Star)
     |
  Switch
     |
...
Ping tests: 	PC0 -> Laptop0 (same subnet)
		PC0 -> Printer1 (different subnet, routed via router)
		Laptop0 -> PC1 (cross-department communication)
Results: All tests were successful, showing evidence of communication across departments.
